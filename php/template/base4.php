						...
						<div class="col-lg-4">
							<div class="form-control-border form-control-transparent form-fs-md d-flex">
								...
								<div class="flex-grow-1">
									...
									<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"><div class="choices__inner"><select class="form-select js-choice choices__input" data-search-enabled="true" hidden="" tabindex="-1" data-choice="active"><option value="" data-custom-properties="[object Object]">Select location</option></select><div class="choices__list choices__list--single"><div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" data-custom-properties="[object Object]" aria-selected="true">Select location</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="search" name="search_terms" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="Select location" placeholder=""><div class="choices__list" role="listbox"><div id="choices--lodi-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Select location</div><div id="choices--lodi-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="San Jacinto, USA" data-select-text="Press to select" data-choice-selectable="">San Jacinto, USA</div><div id="choices--lodi-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="North Dakota, Canada" data-select-text="Press to select" data-choice-selectable="">North Dakota, Canada</div><div id="choices--lodi-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="West Virginia, Paris" data-select-text="Press to select" data-choice-selectable="">West Virginia, Paris</div></div></div></div>
								</div>
							</div>
						</div>
	...
	<div class="container">
		...
		<div class="tiny-slider arrow-round arrow-blur arrow-hover">
			...
			<div class="tns-item tns-slide-cloned tns-slide-active">
				...
				</div></div></div></div><div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="tns1"><i class="bi bi-arrow-left"></i></button><button type="button" data-controls="next" tabindex="-1" aria-controls="tns1"><i class="bi bi-arrow-right"></i></button></div></div>
		</div>	
		<!-- Slider END -->
	</div>
</section>
		...
		<div class="row">
			...
			<div class="col-lg-11 mx-auto">
				<div class="tiny-slider arrow-round arrow-border arrow-hover">
					<div class="tns-outer" id="tns2-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">4 to 6</span>  of 2</div><div id="tns2-mw" class="tns-ovh"><div class="tns-inner" id="tns2-iw"><div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-edge="2" data-items="1" id="tns2" style="transform: translate3d(-50%, 0px, 0px); transition-duration: 0s;"><div class="px-4 px-md-5 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
						...
						</div><div class="px-4 px-md-5 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
							<div class="row justify-content-between align-items-center">
					...
					<div class="px-4 px-md-5 tns-item tns-slide-cloned tns-slide-active">
						...
						</div></div></div></div><div class="tns-nav" aria-label="Carousel Pagination"><button type="button" data-nav="0" aria-controls="tns2" style="" aria-label="Carousel Page 1" class="" tabindex="-1"></button><button type="button" data-nav="1" aria-controls="tns2" style="" aria-label="Carousel Page 2 (Current Slide)" class="tns-nav-active"></button></div><div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="tns2"><i class="bi bi-arrow-left"></i></button><button type="button" data-controls="next" tabindex="-1" aria-controls="tns2"><i class="bi bi-arrow-right"></i></button></div></div>
				</div>	
			</div>
			<!-- Slider END -->
		</div>
...
<!-- ThemeFunctions -->
<script src="assets/js/functions.js"></script><div class="flatpickr-calendar rangeMode arrowBottom arrowLeft" tabindex="-1" style="top: 898.188px; left: 75.1875px; right: auto;"><div class="flatpickr-months"><span class="flatpickr-prev-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M5.207 8.471l7.146 7.147-0.707 0.707-7.853-7.854 7.854-7.853 0.707 0.707-7.147 7.146z"></path></svg></span><div class="flatpickr-month"><div class="flatpickr-current-month"><select class="flatpickr-monthDropdown-months" aria-label="Month" tabindex="-1"><option class="flatpickr-monthDropdown-month" value="0" tabindex="-1">January</option><option class="flatpickr-monthDropdown-month" value="1" tabindex="-1">February</option><option class="flatpickr-monthDropdown-month" value="2" tabindex="-1">March</option><option class="flatpickr-monthDropdown-month" value="3" tabindex="-1">April</option><option class="flatpickr-monthDropdown-month" value="4" tabindex="-1">May</option><option class="flatpickr-monthDropdown-month" value="5" tabindex="-1">June</option><option class="flatpickr-monthDropdown-month" value="6" tabindex="-1">July</option><option class="flatpickr-monthDropdown-month" value="7" tabindex="-1">August</option><option class="flatpickr-monthDropdown-month" value="8" tabindex="-1">September</option><option class="flatpickr-monthDropdown-month" value="9" tabindex="-1">October</option><option class="flatpickr-monthDropdown-month" value="10" tabindex="-1">November</option><option class="flatpickr-monthDropdown-month" value="11" tabindex="-1">December</option></select><div class="numInputWrapper"><input class="numInput cur-year" type="number" tabindex="-1" aria-label="Year"><span class="arrowUp"></span><span class="arrowDown"></span></div></div></div><span class="flatpickr-next-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M13.207 8.472l-7.854 7.854-0.707-0.707 7.146-7.146-7.146-7.148 0.707-0.707 7.854 7.854z"></path></svg></span></div><div class="flatpickr-innerContainer"><div class="flatpickr-rContainer"><div class="flatpickr-weekdays"><div class="flatpickr-weekdaycontainer">
      <span class="flatpickr-weekday">
        Sun</span><span class="flatpickr-weekday">Mon</span><span class="flatpickr-weekday">Tue</span><span class="flatpickr-weekday">Wed</span><span class="flatpickr-weekday">Thu</span><span class="flatpickr-weekday">Fri</span><span class="flatpickr-weekday">Sat
      </span>
      </div></div><div class="flatpickr-days" tabindex="-1"><div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="August 28, 2022" tabindex="-1">28</span><span class="flatpickr-day prevMonthDay" aria-label="August 29, 2022" tabindex="-1">29</span><span class="flatpickr-day prevMonthDay" aria-label="August 30, 2022" tabindex="-1">30</span><span class="flatpickr-day prevMonthDay" aria-label="August 31, 2022" tabindex="-1">31</span><span class="flatpickr-day " aria-label="September 1, 2022" tabindex="-1">1</span><span class="flatpickr-day " aria-label="September 2, 2022" tabindex="-1">2</span><span class="flatpickr-day " aria-label="September 3, 2022" tabindex="-1">3</span><span class="flatpickr-day " aria-label="September 4, 2022" tabindex="-1">4</span><span class="flatpickr-day " aria-label="September 5, 2022" tabindex="-1">5</span><span class="flatpickr-day " aria-label="September 6, 2022" tabindex="-1">6</span><span class="flatpickr-day " aria-label="September 7, 2022" tabindex="-1">7</span><span class="flatpickr-day " aria-label="September 8, 2022" tabindex="-1">8</span><span class="flatpickr-day " aria-label="September 9, 2022" tabindex="-1">9</span><span class="flatpickr-day " aria-label="September 10, 2022" tabindex="-1">10</span><span class="flatpickr-day " aria-label="September 11, 2022" tabindex="-1">11</span><span class="flatpickr-day " aria-label="September 12, 2022" tabindex="-1">12</span><span class="flatpickr-day " aria-label="September 13, 2022" tabindex="-1">13</span><span class="flatpickr-day " aria-label="September 14, 2022" tabindex="-1">14</span><span class="flatpickr-day " aria-label="September 15, 2022" tabindex="-1">15</span><span class="flatpickr-day " aria-label="September 16, 2022" tabindex="-1">16</span><span class="flatpickr-day " aria-label="September 17, 2022" tabindex="-1">17</span><span class="flatpickr-day " aria-label="September 18, 2022" tabindex="-1">18</span><span class="flatpickr-day selected startRange" aria-label="September 19, 2022" tabindex="-1">19</span><span class="flatpickr-day inRange" aria-label="September 20, 2022" tabindex="-1">20</span><span class="flatpickr-day inRange" aria-label="September 21, 2022" tabindex="-1">21</span><span class="flatpickr-day inRange" aria-label="September 22, 2022" tabindex="-1">22</span><span class="flatpickr-day inRange" aria-label="September 23, 2022" tabindex="-1">23</span><span class="flatpickr-day inRange" aria-label="September 24, 2022" tabindex="-1">24</span><span class="flatpickr-day inRange" aria-label="September 25, 2022" tabindex="-1">25</span><span class="flatpickr-day inRange" aria-label="September 26, 2022" tabindex="-1">26</span><span class="flatpickr-day inRange" aria-label="September 27, 2022" tabindex="-1">27</span><span class="flatpickr-day selected endRange" aria-label="September 28, 2022" tabindex="-1">28</span><span class="flatpickr-day " aria-label="September 29, 2022" tabindex="-1">29</span><span class="flatpickr-day " aria-label="September 30, 2022" tabindex="-1">30</span><span class="flatpickr-day nextMonthDay" aria-label="October 1, 2022" tabindex="-1">1</span><span class="flatpickr-day nextMonthDay" aria-label="October 2, 2022" tabindex="-1">2</span><span class="flatpickr-day nextMonthDay" aria-label="October 3, 2022" tabindex="-1">3</span><span class="flatpickr-day nextMonthDay" aria-label="October 4, 2022" tabindex="-1">4</span><span class="flatpickr-day nextMonthDay" aria-label="October 5, 2022" tabindex="-1">5</span><span class="flatpickr-day nextMonthDay" aria-label="October 6, 2022" tabindex="-1">6</span><span class="flatpickr-day nextMonthDay" aria-label="October 7, 2022" tabindex="-1">7</span><span class="flatpickr-day nextMonthDay" aria-label="October 8, 2022" tabindex="-1">8</span></div></div></div></div></div>
