    ...
    <aside class="sidebar" data-sidebar>
      <div class="top-sidebar">
        <a href="#" class="small-logo">
          <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.01-.003.268-.108a.75.75 0 0 1 .558 0l.269.108.01.003 6.97 2.789ZM10.404 2 4.25 4.461 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339L8 5.961 5.596 5l6.154-2.461L10.404 2Z"/>
          </svg>
        </a>
        <div class="hidden-sidebar your-channel">Your ecommerce</div>
        <div class="hidden-sidebar channel-name">Demo</div>
      </div>
      <div class="middle-sidebar">
        <ul class="sidebar-list">
          ...
          <li class="sidebar-list-item">
            <a href="./signup-view.php" class="sidebar-link">
              ...
              <div class="hidden-sidebar">Sign in</div>
            </a>
          </li>
          <li class="sidebar-list-item">
            <a href="./signup-view.php" class="sidebar-link">
              <svg viewBox="0 0 24 24" class="sidebar-icon" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z"></path></g></svg>
              <div class="hidden-sidebar">Log in</div>
            </a>
          </li>
          <li class="sidebar-list-item">
            <a href="#" class="sidebar-link">
