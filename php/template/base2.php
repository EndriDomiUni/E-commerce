        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <button type="button" data-bs-target="#" class="btn btn-link" aria-current="page">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="nav-all-icon">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-link" aria-current="page" data-bs-target="#">
                            <!-- <a class="nav-link active" aria-current="page" href="#"> -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="nav-all-icon">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-link" aria-current="page" data-bs-target="#">
                            <a class="nav-link active" aria-current="page" href="login-view.php">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-link" aria-current="page" data-bs-target="#">
                            <a class="nav-link active" aria-current="page" href="shop-cart-view.php">
                                <svg xmlns="http://www.w3.org/2000/svg" class="nav-all-icon">
