...
<head>
    ...
    <!-- basta avere bootstrap per le icone -->
                                    ...
                                    <div class="form-control-border form-control-transparent form-fs-md d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false">
                                                <div class="choices__inner"><select class="form-select js-choice choices__input" data-search-enabled="true" hidden="" tabindex="-1" data-choice="active">
                                                        <option value="" data-custom-properties="[object Object]">Select location</option>
                                                    </select>
                                                    <div class="choices__list choices__list--single">
                                                        <div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" data-custom-properties="[object Object]" aria-selected="true">Select location</div>
                                                    </div>
                                                </div>
                                                <div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="search" name="search_terms" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="Select location" placeholder="">
                                                    <div class="choices__list" role="listbox">
                                                        <div id="choices--lodi-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Select location</div>
                                                        <div id="choices--lodi-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="San Jacinto, USA" data-select-text="Press to select" data-choice-selectable="">San Jacinto, USA</div>
                                                        <div id="choices--lodi-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="North Dakota, Canada" data-select-text="Press to select" data-choice-selectable="">North Dakota, Canada</div>
                                                        <div id="choices--lodi-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="West Virginia, Paris" data-select-text="Press to select" data-choice-selectable="">West Virginia, Paris</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="form-control-border form-control-transparent form-fs-md">
                                            ...
                                            <input type="text" class="form-control flatpickr flatpickr-input" data-mode="range" placeholder="Select date" value="19 Sep to 28 Sep" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="tiny-slider arrow-round arrow-blur arrow-hover">
                    <div class="tns-outer" id="tns1-ow">
                        <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">12 to 14</span> of 4</div>
                        <div id="tns1-mw" class="tns-ovh">
                            <div class="tns-inner" id="tns1-iw">
                                <div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items-xl="3" data-items-lg="2" data-items-md="1" id="tns1" style="transform: translate3d(-66.6667%, 0px, 0px); transition-duration: 0s;">
                        ...
                        <div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="tns1"><i class="bi bi-arrow-left"></i></button><button type="button" data-controls="next" tabindex="-1" aria-controls="tns1"><i class="bi bi-arrow-right"></i></button></div>
                    </div>
                </div>
                <!-- Slider END -->
            </div>
                    ...
                    <div class="col-lg-11 mx-auto">
                        <div class="tiny-slider arrow-round arrow-border arrow-hover">
                            <div class="tns-outer" id="tns2-ow">
                                <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">4 to 6</span> of 2</div>
                                <div id="tns2-mw" class="tns-ovh">
                                    <div class="tns-inner" id="tns2-iw">
                                        <div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-edge="2" data-items="1" id="tns2" style="transform: translate3d(-50%, 0px, 0px); transition-duration: 0s;">
                                            ...
                                            <!-- Slide item START -->
                                            <div class="px-4 px-md-5 tns-item tns-slide-active" id="tns2-item0">
                                                <div class="row justify-content-between align-items-center">
                                            ...
                                            <!-- Slide item START -->
                                            <div class="px-4 px-md-5 tns-item tns-slide-active" id="tns2-item1">
                                                <div class="row justify-content-between align-items-center">
                                            ...
                                            <div class="px-4 px-md-5 tns-item tns-slide-cloned tns-slide-active">
                                                <div class="row justify-content-between align-items-center">
                                ...
                                <div class="tns-nav" aria-label="Carousel Pagination"><button type="button" data-nav="0" aria-controls="tns2" style="" aria-label="Carousel Page 1" class="" tabindex="-1"></button><button type="button" data-nav="1" aria-controls="tns2" style="" aria-label="Carousel Page 2 (Current Slide)" class="tns-nav-active"></button></div>
                                <div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="tns2"><i class="bi bi-arrow-left"></i></button><button type="button" data-controls="next" tabindex="-1" aria-controls="tns2"><i class="bi bi-arrow-right"></i></button></div>
                            </div>
                        </div>
                    </div>
                    <!-- Slider END -->
...
Footer END -->
    ...
    <div class="flatpickr-calendar rangeMode arrowBottom arrowLeft" tabindex="-1" style="top: 898.188px; left: 75.1875px; right: auto;">
        ...
        <div class="flatpickr-innerContainer">
            <div class="flatpickr-rContainer">
                ...
                <div class="flatpickr-days" tabindex="-1">
                    <div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="August 28, 2022" tabindex="-1">28</span><span class="flatpickr-day prevMonthDay" aria-label="August 29, 2022" tabindex="-1">29</span><span class="flatpickr-day prevMonthDay" aria-label="August 30, 2022" tabindex="-1">30</span><span class="flatpickr-day prevMonthDay" aria-label="August 31, 2022" tabindex="-1">31</span><span class="flatpickr-day " aria-label="September 1, 2022" tabindex="-1">1</span><span class="flatpickr-day " aria-label="September 2, 2022" tabindex="-1">2</span><span class="flatpickr-day " aria-label="September 3, 2022" tabindex="-1">3</span><span class="flatpickr-day " aria-label="September 4, 2022" tabindex="-1">4</span><span class="flatpickr-day " aria-label="September 5, 2022" tabindex="-1">5</span><span class="flatpickr-day " aria-label="September 6, 2022" tabindex="-1">6</span><span class="flatpickr-day " aria-label="September 7, 2022" tabindex="-1">7</span><span class="flatpickr-day " aria-label="September 8, 2022" tabindex="-1">8</span><span class="flatpickr-day " aria-label="September 9, 2022" tabindex="-1">9</span><span class="flatpickr-day " aria-label="September 10, 2022" tabindex="-1">10</span><span class="flatpickr-day " aria-label="September 11, 2022" tabindex="-1">11</span><span class="flatpickr-day " aria-label="September 12, 2022" tabindex="-1">12</span><span class="flatpickr-day " aria-label="September 13, 2022" tabindex="-1">13</span><span class="flatpickr-day " aria-label="September 14, 2022" tabindex="-1">14</span><span class="flatpickr-day " aria-label="September 15, 2022" tabindex="-1">15</span><span class="flatpickr-day " aria-label="September 16, 2022" tabindex="-1">16</span><span class="flatpickr-day " aria-label="September 17, 2022" tabindex="-1">17</span><span class="flatpickr-day " aria-label="September 18, 2022" tabindex="-1">18</span><span class="flatpickr-day selected startRange" aria-label="September 19, 2022" tabindex="-1">19</span><span class="flatpickr-day inRange" aria-label="September 20, 2022" tabindex="-1">20</span><span class="flatpickr-day inRange" aria-label="September 21, 2022" tabindex="-1">21</span><span class="flatpickr-day inRange" aria-label="September 22, 2022" tabindex="-1">22</span><span class="flatpickr-day inRange" aria-label="September 23, 2022" tabindex="-1">23</span><span class="flatpickr-day inRange" aria-label="September 24, 2022" tabindex="-1">24</span><span class="flatpickr-day inRange" aria-label="September 25, 2022" tabindex="-1">25</span><span class="flatpickr-day inRange" aria-label="September 26, 2022" tabindex="-1">26</span><span class="flatpickr-day inRange" aria-label="September 27, 2022" tabindex="-1">27</span><span class="flatpickr-day selected endRange" aria-label="September 28, 2022" tabindex="-1">28</span><span class="flatpickr-day " aria-label="September 29, 2022" tabindex="-1">29</span><span class="flatpickr-day " aria-label="September 30, 2022" tabindex="-1">30</span><span class="flatpickr-day nextMonthDay" aria-label="October 1, 2022" tabindex="-1">1</span><span class="flatpickr-day nextMonthDay" aria-label="October 2, 2022" tabindex="-1">2</span><span class="flatpickr-day nextMonthDay" aria-label="October 3, 2022" tabindex="-1">3</span><span class="flatpickr-day nextMonthDay" aria-label="October 4, 2022" tabindex="-1">4</span><span class="flatpickr-day nextMonthDay" aria-label="October 5, 2022" tabindex="-1">5</span><span class="flatpickr-day nextMonthDay" aria-label="October 6, 2022" tabindex="-1">6</span><span class="flatpickr-day nextMonthDay" aria-label="October 7, 2022" tabindex="-1">7</span><span class="flatpickr-day nextMonthDay" aria-label="October 8, 2022" tabindex="-1">8</span></div>
                </div>
            </div>
        </div>
    </div>
