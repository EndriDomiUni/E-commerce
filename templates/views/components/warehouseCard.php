<section class="container my-5">
    ...
    foreach ($warehouses as $warehouse){
        ...
        $articlesQuantity = $session->getArticles
                ...
                <div class="card mb-3 center-block d-flex justify-content-center" style="max-width: 540px;">
                    <!--<div class="row no-gutters">-->
                        <div class="card-body">
                            ...
                            <p class="card-text">Numero articoli: ' . '</p>
                        </div>
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <button class="btn btn-primary ml-auto" type="submit" name="manage-articles-'.$warehouse[0][ID].'-configuration">
                            ...
                            <!--
                            <button class="btn btn-primary ml-auto" type="submit" name="edit-product-'.$warehouse[0][ID].'">
                            ...
                            <button class="btn btn-red ml-auto" type="submit" name="delete-product-'.$warehouse[0][ID].'">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-fill" viewBox="0 0 16 16">
                                    <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z"/>
                                </svg>
                                Delete product
