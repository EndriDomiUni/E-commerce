<footer>
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <p class="col-md-4 mb-0" style="color: white;">© 2022 Company, Inc</p>
            ...
            <ul class="nav col-md-4 justify-content-end">
                <li class="nav-item"><a href="./index.php" class="nav-link px-2" style="color: white;">Home</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2" style="color: white;">Features</a></li>
                <li class="nav-item"><a href="./premium.php" class="nav-link px-2" style="color: white;">Pricing</a></li>
