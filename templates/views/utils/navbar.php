    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <!-- start home -->
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="<?php echo INDEX; ?>">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto justify-content-between" id="btn-toogle-navbar">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end ">
                        <li><a class="dropdown-item" href="<?php echo SIGN-IN ?>">Login in</a></li>
                        <li><a class="dropdown-item" href="<?php echo SIGN-UP ?>">Sign up</a></li>
                        <li><a class="dropdown-item" href="<?php echo INBOX ?>">Inbox</a></li>
                        <li>
