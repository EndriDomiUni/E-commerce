<nav class="navbar navbar-expand-lg bg-light bd-navbar sticky-top" id="navbar-main">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo ROOT; ?>">
            <img src="<?php echo IMG; ?>/logo.svg" width="44px" height="44px" alt="Logo">
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 flex-row justify-content-between">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="<?php echo ROOT; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" fill="currentColor" class="bi bi-house-door-fill nav-icon-item" viewBox="0 0 16 16">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" fill="currentColor" class="bi bi-inbox-fill nav-icon-item" viewBox="0 0 16 16">
